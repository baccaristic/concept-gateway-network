...
export const generateAgreementHtml = (
  ...
  return `
    ...
    <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; padding: 20px;">
      ...
      <h2 style="text-align: center; margin-bottom: 30px;">${idea.title || 'Untitled Idea'}</h2>
      ...
      <div style="border: 1px solid #e5e7eb; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
        ...
        <p style="line-height: 1.6;">The purpose of this Agreement is to establish the terms and conditions under which the Investor will provide funding for the development of the idea titled "${idea.title || 'Untitled'}" (the "Project").</p>
        
        <h4 style="font-size: 16px; margin-top: 25px; margin-bottom: 10px;">2. Investment Amount</h4>
        <p style="line-height: 1.6;">The Investor agrees to invest the sum of $${(idea.estimatedPrice || 0).toLocaleString()} (the "Investment Amount") in the Project.</p>
