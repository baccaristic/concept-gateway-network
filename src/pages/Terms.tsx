          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <div className="prose prose-lg max-w-none">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">1. Account Registration</h2>
                <p>
                ...
                <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">2. Idea Submission</h2>
                <p>
                ...
                <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">3. Investor Obligations</h2>
                <p>
                ...
                <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">4. Expert Evaluations</h2>
                <p>
